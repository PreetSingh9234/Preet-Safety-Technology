...
df["PPE_Status"] = ppe_encoder.fit_transform(df["PPE_Status"])
...
# Features
X = df[["Temperature", "Gas_Level", "Humidity", "Machine_Vibration", "Noise_Level", "Worker_Fatigue", "PPE_Status"]]
...
joblib.dump(ppe_encoder, "model/ppe_encoder.pkl")
