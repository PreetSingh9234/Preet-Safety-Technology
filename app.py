...
# AI INDUSTRIAL WORKER SAFETY INTELLIGENCE PLATFORM
# ==================================================
...
"🚀 RUN AI SAFETY ANALYSIS"
    ...
    ppe_value = ppe_encoder.transform(
        [ppe]
    )[0]
...
zones,
names="Risk",
title="Factory Risk Distribution"
